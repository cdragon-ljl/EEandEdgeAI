...
export function isSeriesId(value: string): value is SeriesId {
  return value === 'cuda' || value === 'ee-system' || value === 'freertos' || value === 'rknn' || value === 'riscv' || value === 'fpga' || value === 'zephyr' || value === 'bsp' || value === 'usb' || value === 'pcie' || value === 'video-audio' || value === 'deep-learning';
}
