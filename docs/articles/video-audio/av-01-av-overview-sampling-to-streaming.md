...
**结论：** 一秒钟 1080p30 的裸视频约 93MB，而百兆以太网的理论上限只有 12.5MB/s，Wi-Fi 实际更不稳。**不压缩，视频在嵌入式设备上寸步难行。**
...
## 五、硬件平台：RV1126 + IMX415

选这套组合，是因为它恰好覆盖了全链路，且每一环都有真实可练的接口：

![av-01-4](./assets/av-01-4.png)
