...
description: "PCIe 协议、PCI Core、DMA/IRQ/IOMMU、PM/AER、Endpoint、高吞吐与 USB 对比的 22 篇学习顺序。"
pubDate: "2026-08-29"
series: pcie
order: 0
...
本系列固定 Linux 6.12 LTS 基线，先建立拓扑、配置空间与 BAR 地址模型，再进入 PCI Core/Driver、IRQ/DMA/IOMMU、PM/AER/性能，最后覆盖 RC/EP、Endpoint Framework、高吞吐、调试和跨总线综合。
...
| 真实数据路径 | 14 igc Ring/NAPI/MSI-X |
| Endpoint 与产品设计 | 15 RC/EP Bring-up；16 Endpoint Framework；17 Multi-queue；18 系统调试 |
| 跨总线综合 | 19 Bus Model；20 Driver Model；21 Debug Evidence；22 Interview/System Design |
