---
title: "嵌入式知识体系 · #11 · Makefile 进阶与 CMake 实战"
description: "很多嵌入式工程师对构建系统的认知停留在「用 IDE 点一下编译按钮」或者「把别人的 Makefile 复制粘贴改一改」。当项目从单个 `.c` 文件膨胀到几十个目录、上千个文件，再加上交叉编译工具链、条件编译、多个 Flash/Linker 配置时，一个整理好的构建系统直接决定研发效率——甚至决定你下班时间。"
pubDate: "2026-07-19"
series: "ee-system"
order: 11
tags: ["嵌入式", "嵌入式知识体系"]
