---
title: "嵌入式知识体系 · #19 · ESP32 双核 FreeRTOS：一核不够，两核怎么用"
description: "ESP32 搭载两片 Xtensa LX6（或 LX7）核心，主频最高 240MHz。它的 FreeRTOS 不是标准的单核版本，而是经过了乐鑫深度改造的 **ESP-IDF FreeRTOS SMP（对称多处理）** 版本。这对从单核 MCU 迁移过来的开发者来说，既是礼物，也是陷阱。"
pubDate: "2026-07-19"
series: "ee-system"
order: 19
tags: ["嵌入式", "嵌入式知识体系"]
