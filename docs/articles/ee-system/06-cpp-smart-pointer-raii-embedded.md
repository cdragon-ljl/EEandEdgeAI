---
title: "嵌入式知识体系 · #06 · C++ 智能指针：嵌入式中的 RAII 与所有权管理"
description: "**裸指针三宗罪**：忘记 `free` 导致内存泄漏、多次 `free` 导致 double-free、野指针访问导致 hardfault。智能指针（smart pointer）就是用 RAII 包裹这些风险，在离开作用域时自动释放资源。"
pubDate: "2026-07-19"
series: "ee-system"
order: 6
tags: ["嵌入式", "嵌入式知识体系"]
