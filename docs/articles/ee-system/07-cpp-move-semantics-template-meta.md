---
title: "嵌入式知识体系 · #07 · C++ 移动语义与模板元编程入门"
description: "C++11 引入的两个革命性特性——移动语义（move semantics）和模板元编程（template metaprogramming）——在嵌入式场景中有巨大的实用价值。移动语义消除不必要的拷贝开销，模板元编程将运行期计算转移至编译期。"
pubDate: "2026-07-19"
series: "ee-system"
order: 7
tags: ["嵌入式", "嵌入式知识体系"]
