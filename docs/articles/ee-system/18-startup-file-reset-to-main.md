---
title: "嵌入式知识体系 · #18 · 启动文件 startup_xxx.s 深度解析：从 Reset 到 main"
description: "嵌入式开发者写了几百个 `main()`，但很少有人问：**MCU 上电后第一条指令执行的是什么？全局变量为什么能在 main 之前就赋好初值？** 答案全藏在那个不起眼的 `startup_xxx.s` 启动文件里。"
pubDate: "2026-07-19"
series: "ee-system"
order: 18
tags: ["嵌入式", "嵌入式知识体系"]
