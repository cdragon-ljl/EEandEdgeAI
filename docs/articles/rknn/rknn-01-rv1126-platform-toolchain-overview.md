---
title: "基于RV1126的端侧AI开发 · 第1期 准备工作及前序知识"
description: "定位：本系列主要学习RKNN 工具链的使用 + 模型部署，从转换、量化、板端推理到性能调优"
pubDate: "2026-08-09"
series: "rknn"
order: 1
...
![board](/EEandEdgeAI/images/rknn/board.png)
开发板资源图，摘自正点原子文档。

![soc](/EEandEdgeAI/images/rknn/soc.png)
...
└───────────────────────────────────────────────────┘
```
![rknn](/EEandEdgeAI/images/rknn/rknn.png)
